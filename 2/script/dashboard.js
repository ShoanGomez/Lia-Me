...
window.addEventListener("load", () => {
  ...
  ).innerText = `Ya han pasado ${months} ${monthText} y ${days} ${dayText}, desde que comenzó nuestra historia de amor. Me alegra mucho estar aún a tu lado y disfrutar cada momento, eres mi calabacita que amaré de por vida. ¡Te Amoooo ❤️!`;
  }
});
